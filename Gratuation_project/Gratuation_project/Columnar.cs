...
namespace Gratuation_project
{
    public partial class Columnar : Form
    {
        ...
        private void Columnar_Load(object sender, EventArgs e)
        {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            MessageBox.Show("The Columnar Transposition cipher is a transposition cipher that follows a simple rule for mixing up the characters in the plaintext to form the ciphertext." +
                    ...
                    "\r\n\r\nInstructions:\r\n1. Enter the plaintext/ciphertext in the main textbox.\r\n2. Enter the key - this should be a string of letters. Alternatively, enter\t    " +
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            string encryptedText = ColumnarCipherEncrypt(plainText, key);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            string decryptedText = ColumnarCipherDecrypt(cipherText, key);
            textBox3.Text = decryptedText;
        }
        private string ColumnarCipherEncrypt(string plainText, string key)
        {
        ...
        private string ColumnarCipherDecrypt(string cipherText, string key)
        {
            int[] keyOrder = GetKeyOrder(key);
            int columnCount = key.Length;
            int rowCount = (int)Math.Ceiling((double)cipherText.Length / columnCount);
            ...
            return plainText.ToString().TrimEnd('X'); // Remove padding
        }
